                ...
                stats.bestSellers.map((item, idx) => (
                  ...
                  >
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <p className="font-medium text-slate-800 dark:text-slate-100 text-sm truncate w-40">
                          {item.name}
                        </p>
        ...
        {activeTab === 'COMPARISON' && (
          <div className="space-y-6 animate-fade-in">
            <div className="bg-white dark:bg-slate-900 p-5 rounded-2xl shadow-sm border border-slate-100 dark:border-slate-800 text-center">
              <p className="text-slate-500 dark:text-slate-400 text-sm font-medium uppercase mb-2">
                Diferencia Mes vs Mes
              </p>
              <div className="flex items-center justify-center gap-3">
                ...
                <span
                  className={`text-sm font-bold px-2 py-1 rounded-full flex items-center gap-1 ${
              ...
              <div style={{ width: '100%', height: 300 }}>
                <ResponsiveContainer width="100%" height="100%">
                  ...
                  >
                    ...
                    <Bar
                      dataKey="Anterior"
                      name={comparisonData.prevMonthName}
                      fill="#94a3b8"
                      radius={[4, 4, 0, 0]}
                    />
                    <Bar
                      dataKey="Actual"
                      name={comparisonData.currentMonthName}
                      fill="#3b82f6"
                      radius={[4, 4, 0, 0]}
                    />
                  </BarChart>
            ...
            <div className="bg-blue-50 dark:bg-blue-900/20 p-4 rounded-xl border border-blue-100 dark:border-blue-800/30">
              ...
              <p className="text-sm text-blue-700 dark:text-blue-200">
                {comparisonData.totalCurrent > comparisonData.totalPrev
                  ? `¡Excelente! Tus ventas han superado al mes anterior en ${formatCurrency(
                      comparisonData.totalCurrent - comparisonData.totalPrev
                    )}. Continúa con las estrategias actuales.`
                  : `Las ventas están un ${Math.abs(comparisonData.percentChange).toFixed(
                      1
                    )}% por debajo del mes pasado. Considera lanzar una oferta para repuntar.`}
              </p>
            </div>
          </div>
        )}
