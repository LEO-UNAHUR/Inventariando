...
| **Descarga** | [GitHub Releases](https://github.com/LEO-UNAHUR/Inventariando/releases/tag/v1.4.3) |
...
### Android
1. Descarga el APK desde [GitHub Releases](https://github.com/LEO-UNAHUR/Inventariando/releases/tag/v1.4.3)
