...
import { Tag, Plus, Trash2, X, Save, Percent, Sun, Moon } from 'lucide-react';
                ...
                <div>
                  ...
                  <p className="text-xs text-slate-400 mt-1">
                    ...
                    {promo.type === PromotionType.BULK &&
                      `Llevando +${promo.minQuantity} u., precio: $${promo.value}`}
                  </p>
                </div>
                <button
        ...
        <div className="fixed inset-0 bg-black/50 z-50 flex items-center justify-center p-4 backdrop-blur-sm animate-fade-in">
          <div className="bg-white dark:bg-slate-900 w-full max-w-md rounded-2xl shadow-2xl overflow-hidden">
            ...
            <form onSubmit={handleSubmit} className="p-4 space-y-4">
                  ...
                  {Object.values(PromotionType).map((t) => (
                    <button
                      ...
                      className={`p-2 rounded-lg text-xs font-bold border ${
                        type === t
                          ? 'bg-pink-100 border-pink-500 text-pink-700 dark:bg-pink-900/40 dark:text-pink-300'
                  ...
                  <div className="flex-1">
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        className="w-full pl-9 border border-slate-300 dark:border-slate-700 bg-white dark:bg-slate-800 rounded-lg p-2 dark:text-white"
                        placeholder="20"
                        required
                      />
                    </div>
              ...
              <button
                type="submit"
                className="w-full bg-pink-600 hover:bg-pink-700 text-white py-3 rounded-xl font-bold mt-4 flex items-center justify-center gap-2"
              >
