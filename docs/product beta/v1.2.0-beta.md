# Inventariando v1.2.0-beta - BETA
...
| **Descarga** | [GitHub Releases](https://github.com/LEO-UNAHUR/Inventariando/releases/tag/v1.2.0-beta) |
...
### Beta v1.2.0-beta
- Primera versión beta del ciclo 1.2
...
### Android
1. Descarga el APK desde [GitHub Releases](https://github.com/LEO-UNAHUR/Inventariando/releases/tag/v1.2.0-beta)
