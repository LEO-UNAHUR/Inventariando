...
| **Descarga** | [GitHub Releases](https://github.com/LEO-UNAHUR/Inventariando/releases/tag/v1.8.1) |
...
### Android
1. Descarga el APK desde [GitHub Releases](https://github.com/LEO-UNAHUR/Inventariando/releases/tag/v1.8.1)
