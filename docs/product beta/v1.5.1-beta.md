# Inventariando v1.5.1-beta - BETA
...
| **Descarga** | [GitHub Releases](https://github.com/LEO-UNAHUR/Inventariando/releases/tag/v1.5.1-beta) |
...
### Beta v1.5.1-beta
- Primera versión beta del ciclo 1.5
...
### Android
1. Descarga el APK desde [GitHub Releases](https://github.com/LEO-UNAHUR/Inventariando/releases/tag/v1.5.1-beta)
